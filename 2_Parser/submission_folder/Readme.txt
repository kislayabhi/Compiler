...
To check if my code works properly in these cases compile my code first.
Once the parser executable is created, I have made a test file named: "Test5"
and have provided a Makefile for you to run that. Everything is present in the Err_recovery
folder.Go there and run "$make".
